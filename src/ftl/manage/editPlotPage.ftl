...
<div class="container-fluid">
	<div class="jumbotron">
	  ...
	  <a class="btn btn-primary btn-lg" href="${indexpath}/manage/addCoursePage.action?plotID=${plot.id}" role="button">添加英语课程</a>
	  <a class="btn btn-primary btn-lg" href="${indexpath}/manage/getCourseListPage.action?plotID=${plot.id}" role="button">查看全部课程</a>
	</div>
