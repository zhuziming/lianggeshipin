...
<div class="container-fluid">
	...
	<#if pageNum lt 5>
		<nav aria-label="Page navigation example">
		  <ul class="pagination justify-content-end">
		    ...
		    <li class="page-item <#if pageNum == 1>active</#if>"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=1">1</a></li>
		    <li class="page-item <#if pageNum == 2>active</#if>"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=2">2</a></li>
		    <li class="page-item <#if pageNum == 3>active</#if>"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=3">3</a></li>
		    <li class="page-item <#if pageNum == 4>active</#if>"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=4">4</a></li>
		    <li class="page-item <#if pageNum == 5>active</#if>"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=5">5</a></li>
		    <li class="page-item <#if pageNum == 6>active</#if>"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=6">6</a></li>
		    <li class="page-item <#if pageNum == 7>active</#if>"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=7">7</a></li>
		    <li class="page-item">
	...
	<#else>	
		<nav aria-label="Page navigation example">
		  <ul class="pagination justify-content-end">
		    ...
		    <li class="page-item"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=${pageNum-3}">${pageNum-3}</a></li>
		    <li class="page-item"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=${pageNum-2}">${pageNum-2}</a></li>
		    <li class="page-item"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=${pageNum-1}">${pageNum-1}</a></li>
		    <li class="page-item active"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=${pageNum}">${pageNum}</a></li>
		    <li class="page-item"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=${pageNum+1}">${pageNum+1}</a></li>
		    <li class="page-item"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=${pageNum+2}">${pageNum+2}</a></li>
		    <li class="page-item"><a class="page-link" href="${indexpath}/front/word4500Page.action?pageNum=${pageNum+3}">${pageNum+3}</a></li>
		    <li class="page-item">
	...
	<div class="row">
	    ...
	    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
	      	<img  src="${indexpath}/word4500Img/${(word_.word)!""}.${word_.img_format}" class="img-fluid rounded float-right">
	    </div>
	    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
	      	<table class="table">
			    <tbody>
			      ...
			      <tr>
			        <td>
			        	<button onclick="document.getElementById('uk_${word_.word}').play()" type="button" class="btn btn-primary"><audio id="uk_${word_.word}" src="${indexpath}/mp3/word4500/uk/${word_.word}.mp3"  class="musicFlag"></audio>英语发音<svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg></button>
			        	<button onclick="document.getElementById('us_${word_.word}').play()" type="button" class="btn btn-primary"><audio id="us_${word_.word}" src="${indexpath}/mp3/word4500/us/${word_.word}.mp3"></audio>美语发音<svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg></button>
			        </td>
			      </tr>
			    </tbody>
		  	</table>
	...
	$(window).scroll(function(){
	    ...
	    if(doHei <= totalheight){
	       if(loadOK){
	       		...
	       		$.ajax({
				   type: "POST",
				   url: "${indexpath}/front/getWord4500.action",
